(() => {
  ...
  function a(t = {}, e = {}) {
    Object.keys(e).forEach((i) => {
      void 0 === t[i]
        ? (t[i] = e[i])
        : o(e[i]) && o(t[i]) && Object.keys(e[i]).length > 0 && a(t[i], e[i]);
    });
  }
  const r = {
    body: {},
    ...
    return function (...e) {
      if (void 0 === e[0]) {
        for (let e = 0; e < this.length; e += 1)
          m.indexOf(t) < 0 &&
            (t in this[e] ? this[e][t]() : f(this[e]).trigger(t));
        return this;
      }
      return this.on(t, ...e);
    };
  ...
  const v = {
    ...
    hasClass: function (...t) {
      const e = u(t.map((t) => t.split(" ")));
      return (
        p(this, (t) => e.filter((e) => t.classList.contains(e)).length > 0)
          .length > 0
      );
    },
    ...
    on: function (...t) {
      ...
      function o(t) {
        ...
        if ((n.indexOf(t) < 0 && n.unshift(t), f(e).is(i))) s.apply(e, n);
        else {
          const t = f(e).parents();
          for (let e = 0; e < t.length; e += 1)
            f(t[e]).is(i) && s.apply(t[e], n);
        }
      }
      function a(t) {
    ...
    offset: function () {
      if (this.length > 0) {
        ...
        return { top: s.top + r - o, left: s.left + c - a };
      }
      return null;
    },
    css: function (t, e) {
    ...
    is: function (t) {
      ...
      if ("string" == typeof t) {
        ...
        for (n = f(t), o = 0; o < n.length; o += 1) if (n[o] === s) return !0;
        return !1;
      }
      if (t === i) return s === i;
      if (t === e) return s === e;
    ...
    nextAll: function (t) {
      ...
      for (; i.nextElementSibling; ) {
        ...
        t ? f(s).is(t) && e.push(s) : e.push(s), (i = s);
      }
      return f(e);
    },
    prev: function (t) {
    ...
    parents: function (t) {
      ...
      for (let i = 0; i < this.length; i += 1) {
        ...
        for (; s; ) t ? f(s).is(t) && e.push(s) : e.push(s), (s = s.parentNode);
      }
      return f(e);
    },
    closest: function (t) {
  ...
  Object.keys(v).forEach((t) => {
    Object.defineProperty(f.fn, t, { value: v[t], writable: !0 });
  });
  const b = f;
  function y(t, e) {
          ...
          void 0 !== o &&
            ...
            (S(t[n]) && S(s[n])
              ? s[n].__swiper__
                ...
                : E(t[n], s[n])
              : !S(t[n]) && S(s[n])
              ? ((t[n] = {}), s[n].__swiper__ ? (t[n] = s[n]) : E(t[n], s[n]))
              : (t[n] = s[n]));
        }
      }
    }
  ...
  const z = {
    ...
    updateSlides: function () {
      ...
      "string" == typeof y &&
        ...
        s.centeredSlides &&
          s.cssMode &&
          (T(t.wrapperEl, "--swiper-centered-offset-before", ""),
      ...
      for (let n = 0; n < h; n += 1) {
        ...
        const a = d.eq(n);
        if (
          (C && t.grid.updateSlide(n, a, h, e), "none" !== a.css("display"))
        ) {
      ...
      if (
        ...
        C && t.grid.updateWrapperSize(E, u, e),
        !s.centeredSlides)
      ) {
        const e = [];
      ...
      if (
        ...
        T(t.wrapperEl, "--swiper-centered-offset-before", -u[0] + "px"),
          T(
            t.wrapperEl,
      ...
      if (
        ...
        if (0 === e) r[t ? "scrollLeft" : "scrollTop"] = -d;
          ...
          if (!o.support.smoothScroll)
            return (
              $({ swiper: o, targetPosition: -d, side: t ? "left" : "top" }), !0
            );
  ...
  const N = {
    slideTo: function (t, e, i, s, n) {
      ...
      if (r.cssMode) {
        ...
        if (0 === e) {
          ...
          if (!o.support.smoothScroll)
            return (
              $({ swiper: o, targetPosition: i, side: t ? "left" : "top" }), !0
            );
    ...
    slideToClickedSlide: function () {
      ...
      if (e.loop) {
        ...
        (n = parseInt(b(t.clickedSlide).attr("data-swiper-slide-index"), 10)),
          e.centeredSlides
    ...
    loopCreate: function () {
      ...
      if (i.loopFillGroupWithBlank) {
        ...
        if (t !== i.slidesPerGroup) {
          for (let s = 0; s < t; s += 1) {
            const t = b(e.createElement("div")).addClass(
      ...
      for (let t = 0; t < r.length; t += 1)
        n.append(b(r[t].cloneNode(!0)).addClass(i.slideDuplicateClass));
      for (let t = a.length - 1; t >= 0; t -= 1)
        n.prepend(b(a[t].cloneNode(!0)).addClass(i.slideDuplicateClass));
    },
    loopFix: function () {
      const t = this;
  ...
  function B(t) {
    ...
    if (!i.allowTouchMove)
      return (
        b(c.target).is(s.focusableElements) || (i.allowClick = !1),
        void (
          s.isTouched &&
          (Object.assign(o, { startX: h, startY: u, currentX: h, currentY: u }),
          (s.touchStartTime = w()))
        )
      );
    ...
    if (
      ...
      b(c.target).is(s.focusableElements)
    )
  ...
  function H(t) {
    ...
    if (d > s.longSwipesMs) {
      ...
      "next" === e.swipeDirection &&
        (g >= s.longSwipesRatio
          ? e.slideTo(s.rewind && e.isEnd ? f : u + v)
          : e.slideTo(u)),
      ...
      (l.target === e.navigation.nextEl || l.target === e.navigation.prevEl)
        ? l.target === e.navigation.nextEl
          ? e.slideTo(u + v)
          : e.slideTo(u)
        : ("next" === e.swipeDirection && e.slideTo(null !== f ? f : u + v),
          "prev" === e.swipeDirection && e.slideTo(null !== m ? m : u));
    }
  }
  function W() {
    const t = this,
  ...
  const Y = {
      attachEvents: function () {
        ...
        (t.onTouchStart = R.bind(t)),
          (t.onTouchMove = B.bind(t)),
          (t.onTouchEnd = H.bind(t)),
          i.cssMode && (t.onScroll = G.bind(t)),
          (t.onClick = q.bind(t)),
          s.touch && !j && (e.addEventListener("touchstart", V), (j = !0)),
          X(t, "on");
      },
    ...
    U = (t, e) => t.grid && e.grid && e.grid.rows > 1;
  const Z = {
    setBreakpoint: function () {
      ...
      u && i && t.changeDirection(), E(t.params, l);
  ...
  const J = {
    loadImage: function (t, e, i, s, n, o) {
      ...
      b(t).parent("picture")[0] || (t.complete && n)
        ? l()
        : e
        ? ((r = new a.Image()),
          (r.onload = l),
  ...
  class st {
    ...
    mount(t) {
      ...
      let n = (() => {
        if (t && t.shadowRoot && t.shadowRoot.querySelector) {
          const e = b(t.shadowRoot.querySelector(s()));
    ...
    static use(t) {
      return Array.isArray(t)
        ? (t.forEach((t) => st.installModule(t)), st)
        : (st.installModule(t), st);
    }
  }
  Object.keys(et).forEach((t) => {
    Object.keys(et[t]).forEach((e) => {
      st.prototype[e] = et[t][e];
    });
  }),
    st.use([
      function (t) {
  ...
  function ot(t) {
    ...
    function h() {
      ...
      if (
        ((e.params.navigation = (function (t, e, i, s) {
          const n = l();
          return (
    ...
    function u() {
      ...
      t &&
        ...
        i &&
          i.length &&
          (i.off("click", c), i.removeClass(e.params.navigation.disabledClass));
    }
    i({
      navigation: {
        nextEl: null,
      ...
      s("click", (t, i) => {
        const { $nextEl: s, $prevEl: o } = e.navigation,
          a = i.target;
        if (e.params.navigation.hideOnClick && !b(a).is(o) && !b(a).is(s)) {
          if (
            e.pagination &&
            e.params.pagination &&
  ...
  function at(t) {
    let e,
      { swiper: i, extendParams: s, on: n, emit: o } = t;
    function a() {
          ...
          i.params.autoplay.reverseDirection
            ? i.params.loop
              ...
              ? i.params.autoplay.stopOnLastSlide
                ? c()
                : ((t = i.slideTo(i.slides.length - 1, i.params.speed, !0, !0)),
                  o("autoplay"))
              : ((t = i.slidePrev(i.params.speed, !0, !0)), o("autoplay"))
            : i.params.loop
            ? (i.loopFix(),
            ...
            ? i.params.autoplay.stopOnLastSlide
              ? c()
              : ((t = i.slideTo(0, i.params.speed, !0, !0)), o("autoplay"))
            : ((t = i.slideNext(i.params.speed, !0, !0)), o("autoplay")),
            ((i.params.cssMode && i.autoplay.running) || !1 === t) && a();
        }, s));
    }
    function r() {
      return (
        void 0 === e &&
        !i.autoplay.running &&
        ((i.autoplay.running = !0), o("autoplayStart"), a(), !0)
      );
    }
    function c() {
      return (
        ...
        (i.autoplay.paused ||
          ...
          0 !== t && i.params.autoplay.waitForTransition
            ? ["transitionend", "webkitTransitionEnd"].forEach((t) => {
                i.$wrapperEl[0].addEventListener(t, u);
              })
    ...
    function u(t) {
      i &&
        ...
        (["transitionend", "webkitTransitionEnd"].forEach((t) => {
          i.$wrapperEl[0].removeEventListener(t, u);
        }),
        (i.autoplay.paused = !1),
    ...
    (i.autoplay = { running: !1, paused: !1 }),
      ...
      n("init", () => {
        if (i.params.autoplay.enabled) {
          r();
          l().addEventListener("visibilitychange", h),
            i.params.autoplay.pauseOnMouseEnter &&
              (i.$el.on("mouseenter", p), i.$el.on("mouseleave", f));
        }
      }),
      n("beforeTransitionStart", (t, e, s) => {
        i.autoplay.running &&
      ...
      n("destroy", () => {
        ...
        l().removeEventListener("visibilitychange", h);
      }),
      Object.assign(i.autoplay, { pause: d, run: a, start: r, stop: c });
  }
  function rt() {
      ...
      for (let t = 0; t < n; t++) {
        ...
        for (let t in n)
          if (n.hasOwnProperty(t)) {
            const s = n[t];
            if (e && (Array.isArray(s) || ct(s))) {
              const e = Array.isArray(s) ? [] : {};
              i[t] = dt(!0, i.hasOwnProperty(t) ? i[t] : e, s);
            } else i[t] = s;
          }
      }
      return i;
      ...
      (this._element = t),
        ...
        (this._touchStart = (t) => {
          for (const e of Array.from(t.changedTouches || []))
            this._triggerPointerStart(new ft(e), t);
        }),
        (this._move = (t) => {
          const e = this.currentPointers.slice(),
            i = ((t) => "changedTouches" in t)(t)
              ? Array.from(t.changedTouches).map((t) => new ft(t))
              : [new ft(t)];
          for (const t of i) {
        ...
        (this._pointerEnd = (t) => {
          (t.buttons > 0 && 0 !== t.button) ||
            (this._triggerPointerEnd(new ft(t), t) &&
        ...
        (this._touchEnd = (t) => {
          for (const e of Array.from(t.changedTouches || []))
            this._triggerPointerEnd(new ft(e), t);
        }),
  ...
  class bt {
    constructor(t = {}) {
      (this.options = dt(!0, {}, t)), (this.plugins = []), (this.events = {});
    ...
    attachPlugins(t) {
      ...
      for (const [i, s] of Object.entries(t || {}))
        !1 === this.options[i] ||
          this.plugins[i] ||
          ((this.options[i] = dt({}, s.defaults || {}, this.options[i])),
          (e[i] = new s(this)));
  ...
  class wt extends bt {
    constructor(t, e = {}) {
      super(dt(!0, {}, yt, e)), (this.state = "init"), (this.$container = t);
      for (const t of ["onLoad", "onWheel", "onClick"])
        this[t] = this[t].bind(this);
      this.initLayout(),
        this.resetValues(),
        this.attachPlugins(wt.Plugins),
        this.trigger("init"),
        this.updateMetrics(),
        this.attachEvents(),
        this.trigger("ready"),
        ...
        move: (e, i, s) => {
          ...
          if ("xy" === h || "y" !== this.lockAxis) {
            if (
              ...
              const e = gt(t.startPointers[0], t.startPointers[1]),
    ...
    updateMetrics(t) {
      ...
      (c = ht(c * u)), (h = ht(h * u)), (r = c), (l = h);
      const p = i.getBoundingClientRect(),
        f = s.getBoundingClientRect(),
        m = s == e ? f : e.getBoundingClientRect();
      let g = Math.max(s.offsetWidth, ht(f.width)),
        v = Math.max(s.offsetHeight, ht(f.height)),
    ...
    setTransform(t) {
      ...
      if (
        (t
          ? ((e = ht(this.transform.x)),
            (i = ht(this.transform.y)),
        ...
        let t, n;
        (t = ht(this.content.fitWidth * s)),
          (n = ht(this.content.fitHeight * s)),
  ...
  class $t extends bt {
    constructor(t, e = {}) {
      ...
      (this.slideNext = xt(this.slideNext.bind(this), 250)),
        (this.slidePrev = xt(this.slidePrev.bind(this), 250)),
        this.init(),
        (t.__Carousel = this);
    }
    init() {
    ...
    initSlides() {
      (this.slides = []),
        ...
        Array.isArray(this.options.slides) &&
          (this.slides = dt(!0, [...this.slides], this.options.slides));
    }
    updateMetrics() {
      let t,
        e = 0,
      ...
      let s = Math.max(
          ...
          ht(this.$track.getBoundingClientRect().width)
        ),
    ...
    getSlideMetrics(t) {
      ...
      let e = Math.max(t.offsetWidth, ht(t.getBoundingClientRect().width));
    ...
    initPanzoom() {
      ...
      (this.Panzoom = new wt(this.$container, t)),
        this.Panzoom.on({
    ...
    kt = (t) => {
      if (t && Lt) {
        ...
        try {
          ...
          else if (Pt) t.focus({ preventScroll: !0 });
          else {
    ...
    processType(t) {
      ...
      if (!e || "string" == typeof e) {
        if (
          ...
          const n = _t(e, this.fancybox.option("Html.youtube")),
          ...
          const n = _t(e, this.fancybox.option("Html.vimeo")),
            o = encodeURIComponent(s[1]);
          (t.videoId = o),
        ...
        i ||
          ...
          ("html5video" !== i && "video" !== i) ||
            ((t.video = dt({}, this.fancybox.option("Html.video"), t.video)),
            t._width && t._height
              ? (t.ratio = parseFloat(t._width) / parseFloat(t._height))
              : (t.ratio = t.ratio || t.video.ratio || Mt.video.ratio));
      }
    }
    onReady() {
  ...
  class It {
    ...
    initSlidePanzoom(t) {
      t.Panzoom ||
        ((t.Panzoom = new wt(
          t.$el,
          dt(!0, this.fancybox.option("Image.Panzoom", {}), {
            viewport: t.$wrap,
            content: t.$image,
            width: t._width,
            height: t._height,
  ...
  class Dt {
    ...
    static startFromUrl() {
      ...
      const { hash: e, slug: i, index: s } = Dt.getParsedURL();
      if (!i) return;
    ...
    static onHashChange() {
      const { slug: t, index: e } = Dt.getParsedURL(),
        i = Dt.Fancybox,
        s = i && i.getInstance();
      if (s && s.plugins.Hash) {
        if (t) {
    ...
    static create(t) {
      function e() {
        window.addEventListener("hashchange", Dt.onHashChange, !1),
          Dt.startFromUrl();
      }
      (Dt.Fancybox = t),
        Lt &&
    ...
    static destroy() {
      window.removeEventListener("hashchange", Dt.onHashChange, !1);
    }
    static getParsedURL() {
  ...
  const Nt = {
    ...
    activate(t) {
      (Nt.pageXOffset = window.pageXOffset),
        (Nt.pageYOffset = window.pageYOffset),
        t.requestFullscreen
          ? t.requestFullscreen()
      ...
      fullscreen: {
        ...
        click: function (t) {
          t.preventDefault(),
            Nt.element()
              ? Nt.deactivate()
              : Nt.activate(this.fancybox.$container);
        },
      },
      slideshow: {
        type: "button",
  ...
  class Bt {
    ...
    onPrepare() {
      ...
      if (
        ...
        (this.build(),
        this.update(),
        (this.Slideshow = new Ft(t)),
        !t.Carousel.prevPage &&
          (t.option("slideshow.autoStart") && this.Slideshow.activate(),
          t.option("fullscreen.autoStart") && !Nt.element()))
      )
        try {
          Nt.activate(t.$container);
        } catch (t) {}
    }
    onFsChange() {
      window.scrollTo(Nt.pageXOffset, Nt.pageYOffset);
    }
    onSettle() {
      const t = this.fancybox,
        e = this.Slideshow;
    ...
    build() {
      ...
      for (const s of this.fancybox.option("Toolbar.display")) {
        let n, o;
        if (
          (ct(s) ? ((n = s.id), (o = dt({}, t[n], s))) : ((n = s), (o = t[n])),
  ...
  const Ht = {
      ScrollLock: class {
        ...
        onWheel(t) {
          ut(t.composedPath()[0]) || t.preventDefault();
        }
        cleanup() {
          this.pendingUpdate &&
  ...
  class jt extends bt {
    ...
    onClick(t) {
      ...
      if (e.matches("[data-fancybox-close]"))
        return t.preventDefault(), void jt.close(!1, t);
      if (e.matches("[data-fancybox-next]"))
        return t.preventDefault(), void jt.next();
      if (e.matches("[data-fancybox-prev]"))
        return t.preventDefault(), void jt.prev();
      if (
        !(e.matches(Ot) || document.activeElement.blur(),
    ...
    onKeydown(t) {
      if (jt.getInstance().id !== this.id) return;
    ...
    focus(t) {
      if (jt.ignoreFocusChange) return;
      if (
      ...
      t && t.preventDefault(), (jt.ignoreFocusChange = !0);
      ...
      t
        ...
        ? kt(o)
        : a.indexOf(document.activeElement) < 0 && kt(e),
        (this.lastFocus = document.activeElement),
        (jt.ignoreFocusChange = !1);
    }
    hideScrollbar() {
      if (!Lt) return;
      const t =
    ...
    static fromOpener(t, e = {}) {
      let i = [],
        ...
        n = e.target || null;
      const o =
          void 0 !== (e = dt({}, e, jt.openers.get(t))).groupAll && e.groupAll,
      ...
      return (
        ...
        new jt(i, dt({}, e, { startIndex: s, $trigger: n })))
      );
    }
    static bind(t, e = {}) {
      function i() {
        document.body.addEventListener("click", jt.fromEvent, !1);
      }
      Lt &&
        (jt.openers.size ||
          (/complete|interactive|loaded/.test(document.readyState)
    ...
    static unbind(t) {
      jt.openers.delete(t), jt.openers.size || jt.destroy();
    }
    static destroy() {
      let t;
      for (; (t = jt.getInstance()); ) t.destroy();
      (jt.openers = new Map()),
        document.body.removeEventListener("click", jt.fromEvent, !1);
    }
    ...
    static close(t = !0, e) {
      if (t) for (const t of qt.values()) t.close(e);
      else {
  ...
  (jt.version = "4.0.27"),
    ...
    (jt.openers = new Map()),
    (jt.Plugins = Ht),
    jt.bind("[data-fancybox]");
  for (const [t, e] of Object.entries(jt.Plugins || {}))
    "function" == typeof e.create && e.create(jt);
  window.onload = function () {
    document.querySelectorAll(".header__link").forEach((t) => {
      t.href === document.URL && t.classList.add("_active");
    });
    const t = new URL(document.location).searchParams.get("scroll");
    if (t) {
  ...
  let Vt = {
    ...
    Xt = document.querySelector("body");
  if (Vt.any()) {
    Xt.classList.add("touch");
    let t = document.querySelectorAll(".arrow");
    const e = document.querySelector(".header__dropdown-link");
    for (let i = 0; i < t.length; i++) {
      let s = t[i].previousElementSibling,
        n = t[i].nextElementSibling,
        o = t[i];
      s.classList.add("parent"),
        t[i].addEventListener("click", function () {
          n.classList.toggle("open"), o.classList.toggle("active");
        }),
        e.addEventListener("click", function () {
          n.classList.toggle("open"), o.classList.toggle("active");
        });
    }
  } else Xt.classList.add("mouse");
  const Yt = document.querySelector(".reviews__send-button"),
    Ut = document.querySelectorAll(".reviews__input"),
    Zt = document.querySelector(".reviews__textarea");
  if (Yt) {
    const t = () => {
      Ut.forEach((t) => {
        t.value = "";
    ...
    (function () {
      ...
      t &&
        t.addEventListener("click", function (t) {
          e && (i(), document.documentElement.classList.toggle("menu-open"));
        });
    })(),
    new t({});
})();

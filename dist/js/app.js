(() => {
  ...
  function n(t = {}, e = {}) {
    Object.keys(e).forEach((i) => {
      void 0 === t[i]
        ? (t[i] = e[i])
        : s(e[i]) && s(t[i]) && Object.keys(e[i]).length > 0 && n(t[i], e[i]);
    });
  }
  const o = {
    body: {},
  ...
  const m = {
    ...
    is: function (t) {
      ...
      if ("string" == typeof t) {
        ...
        for (n = u(t), o = 0; o < n.length; o += 1) if (n[o] === s) return !0;
        return !1;
      }
      if (t === i) return s === i;
      if (t === e) return s === e;
  ...
  Object.keys(m).forEach((t) => {
    Object.defineProperty(u.fn, t, { value: m[t], writable: !0 });
  });
  const g = u;
  function v(t, e) {
          ...
          void 0 !== o &&
            ...
            (w(t[n]) && w(s[n])
              ? s[n].__swiper__
                ...
                : S(t[n], s[n])
              : !w(t[n]) && w(s[n])
              ? ((t[n] = {}), s[n].__swiper__ ? (t[n] = s[n]) : S(t[n], s[n]))
              : (t[n] = s[n]));
        }
      }
    }
  ...
  const O = {
    ...
    updateSlides: function () {
      ...
      "string" == typeof y &&
        ...
        s.centeredSlides &&
          s.cssMode &&
          (C(t.wrapperEl, "--swiper-centered-offset-before", ""),
          C(t.wrapperEl, "--swiper-centered-offset-after", ""));
      ...
      if (
        ...
        C(t.wrapperEl, "--swiper-centered-offset-before", -u[0] + "px"),
          C(
            t.wrapperEl,
      ...
      if (
        ...
        if (0 === e) r[t ? "scrollLeft" : "scrollTop"] = -d;
          ...
          if (!o.support.smoothScroll)
            return (
              E({ swiper: o, targetPosition: -d, side: t ? "left" : "top" }), !0
            );
    ...
    slideTo: function (t, e, i, s, n) {
      ...
      if (r.cssMode) {
        ...
        if (0 === e) {
          ...
          if (!o.support.smoothScroll)
            return (
              E({ swiper: o, targetPosition: i, side: t ? "left" : "top" }), !0
            );
    ...
    loopCreate: function () {
      ...
      o.each((e, i) => {
        ...
        i < t.loopedSlides && l.push(e),
          i < o.length && i >= o.length - t.loopedSlides && r.push(e),
        ...
        ? ((v = !1),
          n.resistance &&
            (s.currentTranslate =
              i.minTranslate() -
              1 +
              (-i.minTranslate() + s.startTranslate + m) ** y))
        : m < 0 &&
          ...
          n.resistance &&
            (s.currentTranslate =
              i.maxTranslate() +
              1 -
              (i.maxTranslate() - s.startTranslate - m) ** y)),
  ...
  function R(t) {
    ...
    if (d > s.longSwipesMs) {
      ...
      "next" === e.swipeDirection &&
        (g >= s.longSwipesRatio
          ? e.slideTo(s.rewind && e.isEnd ? f : u + y)
          : e.slideTo(u)),
      ...
      (l.target === e.navigation.nextEl || l.target === e.navigation.prevEl)
        ? l.target === e.navigation.nextEl
          ? e.slideTo(u + y)
          : e.slideTo(u)
        : ("next" === e.swipeDirection && e.slideTo(null !== f ? f : u + y),
  ...
  const V = {
      attachEvents: function () {
        ...
        (t.onTouchStart = D.bind(t)),
          (t.onTouchMove = F.bind(t)),
          (t.onTouchEnd = R.bind(t)),
          i.cssMode && (t.onScroll = W.bind(t)),
          (t.onClick = H.bind(t)),
          s.touch && !G && (e.addEventListener("touchstart", q), (G = !0)),
          j(t, "on");
      },
    ...
    X = (t, e) => t.grid && e.grid && e.grid.rows > 1;
  const Y = {
    setBreakpoint: function () {
      ...
      u && i && t.changeDirection(), S(t.params, l);
      ...
      transition: {
        ...
        transitionStart: function (t, e) {
          ...
          s.cssMode ||
            ...
            z({ swiper: i, runCallbacks: t, direction: e, step: "Start" }));
        },
        transitionEnd: function (t, e) {
          ...
          (i.animating = !1),
            s.cssMode ||
              (i.setTransition(0),
              z({ swiper: i, runCallbacks: t, direction: e, step: "End" }));
        },
      },
      slide: I,
      loop: N,
  ...
  function st(t) {
    ...
    i({
      ...
      s("init", () => {
        !1 === e.params.navigation.enabled ? p() : (h(), l());
      }),
      ...
      t.attr("data-swiper-autoplay") &&
        ...
        (e = v(() => {
          ...
          i.params.autoplay.reverseDirection
            ...
            ((i.params.cssMode && i.autoplay.running) || !1 === t) && r();
        }, s));
    }
    function l() {
      return (
    ...
    (i.autoplay = { running: !1, paused: !1 }),
      ...
      n("init", () => {
        if (i.params.autoplay.enabled) {
          l();
          a().addEventListener("visibilitychange", h),
      ...
      for (let t = 0; t < n; t++) {
        ...
        for (let t in n)
          if (n.hasOwnProperty(t)) {
            const s = n[t];
            if (e && (Array.isArray(s) || rt(s))) {
              const e = Array.isArray(s) ? [] : {};
              i[t] = lt(!0, i.hasOwnProperty(t) ? i[t] : e, s);
            } else i[t] = s;
          }
      }
      return i;
      ...
      (this._element = t),
        ...
        (this._touchStart = (t) => {
          for (const e of Array.from(t.changedTouches || []))
            this._triggerPointerStart(new ut(e), t);
        }),
        (this._move = (t) => {
          const e = this.currentPointers.slice(),
            i = ((t) => "changedTouches" in t)(t)
              ? Array.from(t.changedTouches).map((t) => new ut(t))
              : [new ut(t)];
          for (const t of i) {
        ...
        (this._pointerEnd = (t) => {
          (t.buttons > 0 && 0 !== t.button) ||
            (this._triggerPointerEnd(new ut(t), t) &&
        ...
        (this._touchEnd = (t) => {
          for (const e of Array.from(t.changedTouches || []))
            this._triggerPointerEnd(new ut(e), t);
        }),
  ...
  class gt {
    constructor(t = {}) {
      (this.options = lt(!0, {}, t)), (this.plugins = []), (this.events = {});
    ...
    attachPlugins(t) {
      ...
      for (const [i, s] of Object.entries(t || {}))
        !1 === this.options[i] ||
          this.plugins[i] ||
          ((this.options[i] = lt({}, s.defaults || {}, this.options[i])),
          (e[i] = new s(this)));
  ...
  class bt extends gt {
    constructor(t, e = {}) {
      super(lt(!0, {}, vt, e)), (this.state = "init"), (this.$container = t);
      for (const t of ["onLoad", "onWheel", "onClick"])
        this[t] = this[t].bind(this);
      this.initLayout(),
        this.resetValues(),
        this.attachPlugins(bt.Plugins),
        this.trigger("init"),
        this.updateMetrics(),
        this.attachEvents(),
        this.trigger("ready"),
        ...
        move: (e, i, s) => {
          ...
          if ("xy" === h || "y" !== this.lockAxis) {
            if (
              ...
              const e = ft(t.startPointers[0], t.startPointers[1]),
    ...
    updateMetrics(t) {
      ...
      (c = ct(c * u)), (h = ct(h * u)), (r = c), (l = h);
      const p = i.getBoundingClientRect(),
        f = s.getBoundingClientRect(),
        m = s == e ? f : e.getBoundingClientRect();
      let g = Math.max(s.offsetWidth, ct(f.width)),
        v = Math.max(s.offsetHeight, ct(f.height)),
    ...
    setTransform(t) {
      ...
      if (
        (t
          ? ((e = ct(this.transform.x)),
            (i = ct(this.transform.y)),
        ...
        let t, n;
        (t = ct(this.content.fitWidth * s)),
          (n = ct(this.content.fitHeight * s)),
  ...
  class Et extends gt {
    constructor(t, e = {}) {
      ...
      (this.slideNext = yt(this.slideNext.bind(this), 250)),
        (this.slidePrev = yt(this.slidePrev.bind(this), 250)),
        this.init(),
        (t.__Carousel = this);
    }
    init() {
    ...
    initSlides() {
      (this.slides = []),
        ...
        Array.isArray(this.options.slides) &&
          (this.slides = lt(!0, [...this.slides], this.options.slides));
    }
    updateMetrics() {
      let t,
        e = 0,
      ...
      let s = Math.max(
          ...
          ct(this.$track.getBoundingClientRect().width)
        ),
    ...
    getSlideMetrics(t) {
      ...
      let e = Math.max(t.offsetWidth, ct(t.getBoundingClientRect().width));
    ...
    initPanzoom() {
      ...
      (this.Panzoom = new bt(this.$container, t)),
        this.Panzoom.on({
  ...
  (Et.version = "4.0.27"), (Et.Plugins = St);
  const Tt = !(
    ...
    Lt = (t) => {
      if (t && Tt) {
        ...
        try {
          ...
          else if ($t) t.focus({ preventScroll: !0 });
          else {
    ...
    processType(t) {
      ...
      if (!e || "string" == typeof e) {
        if (
          ...
          const n = Mt(e, this.fancybox.option("Html.youtube")),
          ...
          const n = Mt(e, this.fancybox.option("Html.vimeo")),
            o = encodeURIComponent(s[1]);
          (t.videoId = o),
        ...
        i ||
          ...
          ("html5video" !== i && "video" !== i) ||
            ((t.video = lt({}, this.fancybox.option("Html.video"), t.video)),
            t._width && t._height
  ...
  class _t {
    ...
    initSlidePanzoom(t) {
      t.Panzoom ||
        ((t.Panzoom = new bt(
          t.$el,
          lt(!0, this.fancybox.option("Image.Panzoom", {}), {
            viewport: t.$wrap,
            content: t.$image,
            width: t._width,
            height: t._height,
  ...
  class zt {
    ...
    static startFromUrl() {
      ...
      const { hash: e, slug: i, index: s } = zt.getParsedURL();
      if (!i) return;
    ...
    static onHashChange() {
      const { slug: t, index: e } = zt.getParsedURL(),
        i = zt.Fancybox,
        s = i && i.getInstance();
      if (s && s.plugins.Hash) {
        if (t) {
    ...
    static create(t) {
      function e() {
        window.addEventListener("hashchange", zt.onHashChange, !1),
          zt.startFromUrl();
      }
      (zt.Fancybox = t),
        Tt &&
    ...
    static destroy() {
      window.removeEventListener("hashchange", zt.onHashChange, !1);
    }
    static getParsedURL() {
  ...
  const It = {
    ...
    activate(t) {
      (It.pageXOffset = window.pageXOffset),
        (It.pageYOffset = window.pageYOffset),
        t.requestFullscreen
          ? t.requestFullscreen()
      ...
      fullscreen: {
        ...
        click: function (t) {
          t.preventDefault(),
            It.element()
              ? It.deactivate()
              : It.activate(this.fancybox.$container);
        },
      },
      slideshow: {
        type: "button",
  ...
  class Ft {
    ...
    onPrepare() {
      ...
      if (
        ...
        !t.Carousel.prevPage &&
          ...
          t.option("fullscreen.autoStart") && !It.element()))
      )
        try {
    ...
    build() {
      ...
      for (const s of this.fancybox.option("Toolbar.display")) {
        let n, o;
        if (
          (rt(s) ? ((n = s.id), (o = lt({}, t[n], s))) : ((n = s), (o = t[n])),
  ...
  const Rt = {
      ScrollLock: class {
        ...
        onWheel(t) {
          dt(t.composedPath()[0]) || t.preventDefault();
        }
        cleanup() {
          this.pendingUpdate &&
  ...
  class Gt extends gt {
    ...
    focus(t) {
      ...
      t
        ...
        ? Lt(o)
        : a.indexOf(document.activeElement) < 0 && Lt(e),
    ...
    static fromOpener(t, e = {}) {
      let i = [],
        ...
        n = e.target || null;
      const o =
          void 0 !== (e = lt({}, e, Gt.openers.get(t))).groupAll && e.groupAll,
      ...
      return (
        ...
        new Gt(i, lt({}, e, { startIndex: s, $trigger: n })))
      );
    }
    static bind(t, e = {}) {
      function i() {
  ...
  let qt = {
    ...
    jt = document.querySelector("body");
  if (qt.any()) {
    jt.classList.add("touch");
    ...
    (function () {
      ...
      s &&
        s.addEventListener("click", function (s) {
          t &&
            (((t = 500) => {
              document.documentElement.classList.contains("lock") ? e(t) : i(t);
            })(),
